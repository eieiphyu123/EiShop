...
@section('content')    
    <div class="container-fluid px-4">
        ...
        <div class="card mb-4">
            <div class="card-body">
                <h3 class="text-center my-3">Ei Shopping</h3>
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6 text-end">
                        ...
                        <p>Pyament Method - {{$orderFirst->payment->name}}</p>
                    </div>
                </div>
                    ...
                    <tbody>
                        ...
                        @foreach($orders as $order)
                            <tr>
                                ...
                                <td>{{$order->qty}}</td>
                                <td>{{($order->item->price- ($order->item->discount/100 * $order->item->price)) * $order->qty}}</td>
                            </tr>
                            @php
                ...
                <div class="row">
                    ...
                    <form action="{{route('backend.orders.status',$orderFirst->voucherNo)}}" class="d-grid gap-2 my-5" method="post">
                        @csrf
                        {{method_field('put')}}
